...
<table id="Table_01" width="720" height="1101" border="0" cellpadding="0" cellspacing="0" style="position:absolute;">
	...
	<tr>
		<td rowspan="13">&nbsp;</td>
		<td>
			<a href="#"><img src="<?php echo base_url('assets'); ?>/images/index_03.png" alt="" name="login" width="90" height="46" id="login"></a></td>
		<td colspan="2">
			<a href="#"><img src="<?php echo base_url('assets'); ?>/images/index_04.png" alt="" name="register" width="121" height="46" id="register"></a></td>
		<td colspan="9" rowspan="2">&nbsp;</td>
		<td colspan="3">
			<a href="#"><img src="<?php echo base_url('assets'); ?>/images/index_06.png" alt="" name="logout" width="98" height="46" id="logout"></a></td>
	...
	<tr>
		...
		<td width="314" height="27" colspan="8">
			<input type="text" placeholder=" " style="width:314; height:27; border:none;"></td>
		<td rowspan="11">&nbsp;</td>
		<td colspan="2" rowspan="3">
			<a href="2nd Page/2nd.html"><img src="<?php echo base_url('assets'); ?>/images/index_13.png" alt="" name="find" width="82" height="66" id="find"></a></td>
	...
	<tr>
		<td width="314" height="29" colspan="8" rowspan="2">
			<input type="text" placeholder="Input your Destination" style="width:314; height:29; border:none;"></td></td>
		<td>
